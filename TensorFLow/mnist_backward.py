...
MODEL_SAVE_PATH="home/naesar/tf/model/"
...
def backward(mnist):
	...
	learning_rate=tf.train.exponential_decay(LEARNING_RATE_BASE,global_step,mnist_train.num_examples/BATCH_SIZE,LEARNING_RATE_DECAY,staircase=True)
